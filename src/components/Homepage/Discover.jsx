      ...
      <div className="customContainer py-5 text-white">
        <div className="flex flex-col  lg:flex-row">
          <div className="basis-5/12 py-4">
            ...
            <p className="text-lg py-1 font-thin">From branding to marketing</p>
            <div className="w-full relative mb-8 mt-5">
              ...
              />
              <button className="absolute  left-[50%] xl:left-[38%] border  bg-[#221010] text-white rounded-[34px] px-5 py-[5px]">
                Search
              </button>
            </div>
          </div>
